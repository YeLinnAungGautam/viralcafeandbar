        ...
        <DataTable :value="items" tableStyle="min-width: 50rem">
            ...
            <Column header="Action" class="relative">
                <template #body="{ data }">
                    <TableActions
                        :data="data"
                        route-name="tag-lines"
                        :is-delete="hasPermission('tag_line_delete')"
                        :is-show="hasPermission('tag_line_show')"
                        :is-edit="hasPermission('tag_line_edit')"
                    >
                        <!-- <template #other>
                            <button
