<template>
    <div>
        <form @submit.prevent="handleSubmit">
            ...
            >
                <Tabs class="mb-3" id="descriptionTab" value="en">
                    <TabList>
                        <Tab
            ...
            >
                <div class="mb-5">
                    <InputLabel
                        ...
                        value="Notify short description"
                    />
                    <Textarea
    ...
    <FormButton label="notifications" @submit="handleSubmit" />
</template>
...
const { onFormSubmit } = useFormSubmit(form, "notifications", false);
...
onMounted(() => {
    if (props.editValue != null) {
        ...
        form.tags = props.editValue.tags.map((el) => el.id);
    }
});
</script>
